#!/usr/bin/env python3
"""This implement the LFU cache strategy"""

from settings.base_caching import BaseCaching
...
class LFUCache(BaseCaching):
    ...
    def put(self, key, item):
        ...
        if key is None or item is None:
            ...
            if length >= BaseCaching.MAX_ITEMS and key not in self.cache_data:
                print("{} was added to cache".format(key))
    ...
    def delete(self, key):
        """Deletes a key from the cache dict
        """
